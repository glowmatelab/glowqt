...
START_TEXT = (
    ...
    "──────────────────────────────\n\n"
    "👋 <b>Welcome User!</b>\n"
    "Main aapki high-performance aur elegant group management assistant hoon.\n\n"
    "⚡ <b>Key Capabilities:</b>\n"
    "• <b>Smart Chatbot:</b> AI-powered automated replies aur group engagement.\n"
    ...
    "• <b>Admin Tools:</b> Group operations ko smooth chalane ke liye strong controls.\n"
    "• <b>Social Suite:</b> Advanced AFK system aur customized dynamic greetings.\n\n"
...
HELP_TEXT = (
    ...
    "• <code>/stag</code> ➔ Human Simulation (1-by-1 with typing effect)\n"
    "• <code>/stoptag</code> ➔ Force stop current tagging operations\n\n"
    ...
    "• <code>/afk [reason]</code> ➔ Set your away status with a reason\n"
    "• <code>/back</code> ➔ Return from AFK mode\n\n"
    "🛡️ <b>SYSTEM ADMINISTRATION</b>\n"
    "• <code>/stats</code> ➔ View bot growth and analytics (Owner only)\n"
    "• <code>/broadcast</code> ➔ Send alert to all groups (Owner only)\n\n"
    "⚠️ <b>Note:</b> Sabhi tagging operations ke liye Admin permissions mandatory hain."
    "</blockquote>"
)
